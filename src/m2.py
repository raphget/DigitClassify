# purpose: Keras model(L2 Regularization)
# -------------------------------------------------
import os
...
def generateModel(X_train,y_train,X_test,y_test):
    ...
    model.add(Dense(500,  activation="sigmoid", kernel_regularizer=l2(0.001)))
    model.add(Dense(500, activation="sigmoid", kernel_regularizer=l2(0.001)))
...
def main():
    ...
    generateHeatMap(y_test,y_pred,"./output/hmm2.pdf")
    ...
    generateBarPlot(report, 'M2 Performance',"./output/barChartm2.pdf")
